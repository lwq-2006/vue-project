...
const cartItems = ref([
  ...
  },
  {
    ...
    items: [
      {
        id: 301,
        name: '【大眼睛与小眼睛】来袭限定三层整妆粉底液妆前乳粉饼套组',
        spec: '颜色分类: P01粉调最白',
        price: 29.9,
        originalPrice: 99.9,
        couponPrice: 29.9,
  ...
  },
  {
    ...
    items: [
      {
        id: 401,
        name: '超级立新 新款笔袋小简约创意可爱少女心ins潮铅笔盒大容量文具袋',
        spec: '颜色分类: 蜡笔小新',
        price: 3.4,
        originalPrice: 3.9,
        couponPrice: 3.4,
  ...
  },
  {
    ...
    items: [
      {
        id: 501,
        name: '38焕新周 法式减龄职业衬衫女新款春夏内搭薄款面试衬衣设计感小众',
        spec: '尺码: S',
        price: 78.5,
        originalPrice: 87,
        couponPrice: 78.5,
  ...
  },
  {
    ...
    items: [
      {
        id: 601,
        name: '超级立新 甜美黄色小刺猬条纹衬衫女大学生2025春夏新款宽松bf风',
        spec: '尺码: S',
        price: 31.2,
        originalPrice: 45.8,
        couponPrice: 31.2,
  ...
  },
  {
    ...
    items: [
      {
        id: 701,
        name: '38焕新周 AONW美式涂鸦印花连帽卫衣女秋冬新款加绒宽松',
        spec: '尺码: S',
        price: 121,
        originalPrice: 138,
        couponPrice: 121,
  ...
  },
  {
    ...
    items: [
      {
        id: 801,
        name: '38焕新周 韩系休闲运动套装女春秋季学院风宽松拼色外套',
        spec: '尺码: S',
        price: 120.67,
        originalPrice: 138,
        couponPrice: 120.67,
  ...
  },
  {
    ...
    items: [
      {
        id: 901,
        name: 'JEEP美式条纹外套女2026新款小个子早秋立领韩版学院风运动',
        spec: '尺码: S',
        price: 99,
        originalPrice: 124,
        couponPrice: 99,
...
const cartItemCount = computed(() => {
  return cartItems.value.reduce((total, shop) => {
    return total + shop.items.reduce((shopTotal, item) => {
      return shopTotal + item.quantity
    }, 0)
  }, 0)
})
